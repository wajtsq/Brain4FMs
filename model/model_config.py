...
class ModelPathArgs:
    ...
    Bendr_path: str = '/pretrained_weights/Bendr/encoder.pt'
    Bendr_contextualizer_path: str = '/pretrained_weights/Bendr/contextualizer.pt'
    SppEEGNet_path: str = '/pretrained_weights/SppEEGNet/tuh_all_ckp.pt'
    Mbrain_path: str = '/pretrained_weights/Mbrain/EEG'
    Mbrain_SEEG_path: str = '/pretrained_weights/Mbrain/SEEG'
    ...
    MVPFormer_path: str = '/data/brainnet/benchmark/pretrained_weights/MVPFormer/genie-s-base.pt'
    CodeBrain_path: str = '/data/sfq/benchmark/pretrained_weights/CodeBrain/CodeBrain.pth'
    CodeBrain_tokenizer_path: str = '/data/sfq/benchmark/pretrained_weights/CodeBrain/CodeBrain_Tokenizer.pth'
